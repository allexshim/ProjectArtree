package masterpiece.exhibition.excel;
...
/*
 AbstractView를 이용하여 파일 다운로드를 구현한다.
 
 */
	// 받아온 데이터를 엑셀 파일로 저장하는 클래스, 데이터를 넘길때는 Model 타입(데이터를 저장하는 리턴 타입)으로 넘긴다
	@Override
	protected void renderMergedOutputModel(
        ...
        // 자동으로 'hr사원정보_19_12_31'과 같이 저장된다.
