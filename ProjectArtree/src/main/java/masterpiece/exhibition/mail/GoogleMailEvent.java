...
import masterpiece.exhibition.mail.MySMTPAuthenticator;


@Component
public class GoogleMailEvent {
	
	public void sendmail_NewEvent(String recipient, String emailContents)  
    		throws Exception{
    	...
    	// 제목 설정
    	String subject = "[ARTREE] 새 이벤트가 등록되었습니다. ";
