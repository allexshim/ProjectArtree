...
public class GoogleMail {
    ...
    public void sendmail(String recipient, String temp)  
    		throws Exception{
    	...
    	// 제목 설정
    	String subject = "[Artree] 회원님의 임시 비밀번호가 발급되었습니다.";
    	...
    	msg.setContent("임시비밀번호 : <span style='font-size:14pt; color:red;'>"+temp+"</span>", "text/html;charset=UTF-8");
