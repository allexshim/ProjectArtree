...
public interface InterPreviewDAO { 
	...
	int editEnd(HashMap<String, String> paraMap); // 기대평 게시물 수정
	...
	int addCommentCnt(HashMap<String, String> paraMap); // 댓글 등록 시 게시물의 댓글 갯수 증가 

	int delCommentCnt(HashMap<String, String> paraMap); // 댓글 삭제 시 게시물의 댓글 갯수 감소
