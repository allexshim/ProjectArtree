...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		//	alert("선택");
			...
			let no = $(this).find(".applyingno").text();
			
			
		//	console.log(no);

			window.location.href="/artree/appliedDisplayDetail.at?no=" + no;
...
<body>
	...
	<div id="registerFormContainer">
		...
		<div id="eachStatus">
			...
			<a class="displayStatus currentStatus" id="appliedList" id="appliedDisplay" href="<%= ctxPath %>/appliedDisplayList.at">검토 대기중</a>
		</div>
		...
		<div id="contentContainer">
			<table id="registerFormContents">
				...
				<tbody>
					...
					<tr>
						<td class="applyingno">${ exhibit.applyingno }
							<input type="hidden" name="no" value="${ exhibit.applyingno }" />
						</td>
						<td>${ exhibit.exhibitionname }</td>
						<td>${ exhibit.author }</td>
						<td><img src="<%= ctxPath %>/resources/images/exhibition/waitingBtn.JPG" /></td>
					</tr>
					</c:forEach>
					</c:if>
