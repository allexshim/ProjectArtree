...
<body class="bodybin">
	<div class="headerBin" style="background-image:url('<%= ctxPath %>/resources/images/event/about_back2.png')">
		<div>Artree</div>
	</div>
	
	<div style="margin: 0px 215px 90px 215px; text-align: center;">
		<div style="text-align: center;">
			<img src="<%= ctxPath %>/resources/images/event/untitled.png" style="width: 183px;">
		</div>
		...
		<div style="font-size: 14px; line-height: 23px; text-align: center; margin-top: 40px; margin-bottom: 60px;">
			<span>
				아트맵은 미술작품,작가,전국의 갤러리,전시공간 들의 DB구축에 대한 꾸준한 노력과<br>
				...
				기존 큐레이션 서비스 아트맵의 데이터 분석 기반으로, 네이버 클라우드 플랫폼(NCP)과 협력하여 아티스트가 엑세스 하여<br>
		...
		<div> 
			<img src="<%= ctxPath %>/resources/images/event/mar.png" style="width: 1000px;">
		</div>
	</div>
	...
	<div style="margin-bottom:73px; width: 100%; height: 300px; background-color: #f0f0fa; padding-top: 36px;">
		<div style="width: 800px; margin: 0 auto; font-size: 14px; font-weight: bold;">
			...
			<div style="margin-bottom:31px;">아트맵 ART.Map | 대표 : 김선영</div>
			...
			<div style="float: left;">
				Contact<br><br>
				info@art-map.co.kr<br>
				www.art-map.co.kr<br>
			</div>
		</div>
	</div>
