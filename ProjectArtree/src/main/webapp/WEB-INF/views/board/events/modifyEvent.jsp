...
<script type="text/javascript">
	$(document).ready(function(){ 
		...
		if(${modifyEvent.size != 0}){		
			$("#name").val("${modifyEvent.EXHIBITIONNAME}");
			$("#exhibitionno").val("${modifyEvent.FK_EXHIBITIONNO}");
			$("#title").val("${modifyEvent.EVENTNAME}");
			$("#contents").val("${modifyEvent.CONTENT}");
			$("#no").val("${modifyEvent.no}");
			$("#period").val("${modifyEvent.STARTDATE}");
			$("#periodEnd").val("${modifyEvent.ENDDATE}");			
		} // 수정할 글 정보 입력하기 -----------------------------
		...
		<form name="addEvent">
			<table id="detailTable">
				...
				<tr>
					<td>기간</td>
					<td>
						<input value="" style="width: 10%; text-align: center;" size="2" id="period" name="period" type="text"/>
						~ <input value="" style="width: 10%; text-align: center;" size="2" id="periodEnd" name="periodEnd" type="text"/>
					</td>
				<tr>
				<tr>
					<td colspan="2">
